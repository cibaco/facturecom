...
const Ambassadors = () => {
  ...
  return (
    <section id="ambassadeurs" className="py-12 md:py-20 bg-fce-green text-white relative overflow-hidden">
      {/* Background Accents */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto lg:max-w-none">
          {ambassadors.map((person, index) => (
            ...
            >
              <div className="relative w-36 h-36 sm:w-44 sm:h-44 md:w-48 md:h-48 mx-auto mb-4 md:mb-6">
              ...
              <h3 className="text-xl sm:text-2xl font-bold mb-2 font-serif group-hover:text-fce-orange transition-colors">
                {person.name}
              </h3>
